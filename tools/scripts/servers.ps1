...
function Start-Backend() {
  ...
  Start-Process -FilePath "powershell" -ArgumentList "-NoProfile","-ExecutionPolicy","Bypass","-Command","cd '$root'; node server/src/server.js" -WindowStyle Minimized -PassThru
}
